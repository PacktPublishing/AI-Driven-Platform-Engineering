...
From this lab's directory (`chapter-07/4-langfuse-audit/`):
...
git commit -m "chapter 7 lab 4: langfuse stack + audit pvc + agent v0.3.2"
...
## What Chapter 7 sections this exercises
